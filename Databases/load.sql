...
LOAD DATA LOCAL INFILE '/Users/anindyamehta/Downloads/reviews_photos.csv' INTO TABLE ReviewPhotos FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Users/anindyamehta/Downloads/product.csv' INTO TABLE Products FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;
